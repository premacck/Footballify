...
class AdapterImpl<T : RecyclerView.ViewHolder>(
    ...
    fun onCreateViewHolder(): ViewHolder {
        ...
        layout.dividerDrawable = ColorDrawable(context.findColor(R.color.transparent))
    ...
    protected fun getRowWidth(columnSpan: Int): Int {
        ...
        return Math.min(rowWidth + (columnSpan - 1) * listView.requestedHorizontalSpacing, MasonryUtils.getScreenWidth(context) - context.getDp(20f).toInt())
    }
    ...
    private fun findOrInitializeChildLayout(parentLayout: LinearLayout, childIndex: Int): LinearLayout {
        ...
        if (childLayout == null) {
            ...
            childLayout.dividerDrawable = ColorDrawable(context.findColor(R.color.transparent))
