...
//                .build()
    ...
    private fun createCard() {
        ...
        restApi.createCard("BLUE", File(filePath).createMultiPartImage(), getToken())
    ...
    private fun updateCard() {
        ...
        restApi.updateCard(junaCard?.template?.cardColor, File(filePath).createMultiPartImage(), getToken())
                .setObserverThreadsAndSmartSubscribe({
