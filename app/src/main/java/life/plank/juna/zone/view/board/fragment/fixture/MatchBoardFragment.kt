...
import life.plank.juna.zone.view.base.fragment.BaseMatchFragment
import life.plank.juna.zone.view.common.BoardHeaderListener
...
class MatchBoardFragment : BaseMatchFragment(), BoardHeaderListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.run {
            ...
            league = LeagueDataService.getSpecifiedLeague(board.boardEvent?.leagueName)
    ...
    private fun followBoard() = restApi.followBoard(board.id).execute()
