...
class LastTransactionsAdapter : BaseRecyclerView.Adapter<LastTransactionsAdapter.LastTransactionsViewHolder>() {
    ...
    class LastTransactionsViewHolder(itemView: View) : BaseRecyclerView.ViewHolder(itemView)
}