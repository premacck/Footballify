...
public class ShimmerRelativeLayout extends RelativeLayout {
    ...
    public ShimmerRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ShimmerRelativeLayout, 0, 0);
            try {
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_auto_start)) {
                    setAutoStart(a.getBoolean(R.styleable.ShimmerRelativeLayout_auto_start, false));
                }
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_base_alpha)) {
                    setBaseAlpha(a.getFloat(R.styleable.ShimmerRelativeLayout_base_alpha, 0));
                }
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_duration)) {
                    setDuration(a.getInt(R.styleable.ShimmerRelativeLayout_duration, 0));
                }
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_repeat_count)) {
                    setRepeatCount(a.getInt(R.styleable.ShimmerRelativeLayout_repeat_count, 0));
                }
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_repeat_delay)) {
                    setRepeatDelay(a.getInt(R.styleable.ShimmerRelativeLayout_repeat_delay, 0));
                }
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_repeat_mode)) {
                    setRepeatMode(a.getInt(R.styleable.ShimmerRelativeLayout_repeat_mode, 0));
                }

                if (a.hasValue(R.styleable.ShimmerRelativeLayout_angle)) {
                    int angle = a.getInt(R.styleable.ShimmerRelativeLayout_angle, 0);
                    switch (angle) {
                        default:
                        case 0:
                ...
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_shape)) {
                    int shape = a.getInt(R.styleable.ShimmerRelativeLayout_shape, 0);
                    switch (shape) {
                        default:
                        case 0:
                ...
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_dropOff)) {
                    mMask.dropOff = a.getFloat(R.styleable.ShimmerRelativeLayout_dropOff, 0);
                }
                ...
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_intensity)) {
                    mMask.intensity = a.getFloat(R.styleable.ShimmerRelativeLayout_intensity, 0);
                }
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_relative_width)) {
                    mMask.relativeWidth = a.getFloat(R.styleable.ShimmerRelativeLayout_relative_width, 0);
                }
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_relative_height)) {
                    mMask.relativeHeight = a.getFloat(R.styleable.ShimmerRelativeLayout_relative_height, 0);
                }
                if (a.hasValue(R.styleable.ShimmerRelativeLayout_tilt)) {
                    mMask.tilt = a.getFloat(R.styleable.ShimmerRelativeLayout_tilt, 0);
                }
            } finally {
                a.recycle();
            }
    ...
    private Bitmap tryCreateRenderBitmap() {
        ...
        try {
            ...
            String logMessage = "ShimmerLayout failed to create working bitmap";
