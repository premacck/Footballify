        ...
        findString(intent_post) -> {
            when (feedItemType) {
                ...
                findString(intent_audio) ->
                    spannableStringBuilder.append(findString(posted_audio_on_board_x, boardName))
            }
        }
        findString(intent_comment) -> spannableStringBuilder.append(findString(commented_on_your_post))
