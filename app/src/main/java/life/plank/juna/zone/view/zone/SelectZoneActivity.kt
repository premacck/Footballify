...
import life.plank.juna.zone.data.model.user.Zones
import life.plank.juna.zone.util.common.errorToast
import life.plank.juna.zone.view.home.HomeActivity
import life.plank.juna.zone.view.onboarding.SelectZoneAdapter
...
class SelectZoneActivity : AppCompatActivity() {
    ...
    private fun followZones(zones: Zones) {
        restApi.followZones(zones).setObserverThreadsAndSmartSubscribe({
