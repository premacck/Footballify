...
public class ChatModel{
    ...
    public static List<ChatModel> getChats(Context context){
        ...
        chatModelList.add(new ChatModel("video", context.getString(R.string.lorem_ipsum_text), "http://worldsoccertalk.com/wp-content/uploads/2017/09/425715293c16a2475deab21a67e2746286c86741.jpg",true));
