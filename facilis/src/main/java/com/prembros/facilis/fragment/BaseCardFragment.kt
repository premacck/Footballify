...
abstract class BaseCardFragment : BaseFragment(), CardContainer {
    ...
    override fun isFadeOutEnabled(): Boolean = true
    ...
    open fun pushFragment(baseFragment: BaseFragment, isAddToBackStack: Boolean = true) {
        parentActivity().pushFragment(baseFragment, isAddToBackStack)
    }
